...
describe('favorite blog', () => {
  ...
  test('when list has only one blog returns the title, author, likes of the blog', () => {
...
describe('most blogs', () => {
  ...
  test('when list has only one blog returns the title and the amount of blogs', () => {
...
describe('most likes', () => {
  ...
  test('when list has only one blog returns the author and the likes of the blog', () => {
